...
class CMEMatchingEngine:
    ...
    def run_matching_from_dataframes(self, trader_df, exchange_df) -> tuple:
        ...
        try:
            ...
            total_trades = statistics['original_trader_count'] + statistics['original_exchange_count']
            matched_trades = statistics['matched_trader_count'] + statistics['matched_exchange_count']
