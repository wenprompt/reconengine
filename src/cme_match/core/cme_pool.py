...
class CMEUnmatchedPool:
    ...
    def __init__(self, trader_trades: List[CMETrade], exchange_trades: List[CMETrade]):
        ...
        self._trader_pool: Dict[str, CMETrade] = {trade.trade_id: trade for trade in trader_trades}
        self._exchange_pool: Dict[str, CMETrade] = {trade.trade_id: trade for trade in exchange_trades}
