...
class UnifiedDecomposer:
    ...
    def __init__(self, decomposition_patterns: Optional[Dict[str, Any]] = None):
        ...
        self.crack_pattern: Optional[str] = self.patterns.get("crack")  # e.g., "brent swap" for ICE
        self.spread_pattern: Optional[str] = self.patterns.get("spread")  # e.g., "-" for spreads
    ...
    def _decompose_crack(self, product_name: str, quantity: Decimal) -> List[DecomposedProduct]:
        ...
        return [
            ...
            DecomposedProduct(
                base_product=self.crack_pattern or "",  # e.g., "brent swap", shouldn't be None here
                quantity=quantity,
                is_synthetic=True,   # Synthetic component
            ),
        ]
    
    def _decompose_spread(self, product_name: str, quantity: Decimal) -> List[DecomposedProduct]:
