...
class UnifiedMatrixComparator:
    ...
    def compare_matrices(
        ...
        logger.debug(
            f"Trader positions: {len(trader_matrix.positions)}, Exchange positions: {len(exchange_matrix.positions)}"
        )
    ...
    def _determine_status(
        self, trader_qty: Decimal, exchange_qty: Decimal, diff: Decimal
    ) -> MatchStatus:
