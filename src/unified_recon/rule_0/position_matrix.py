...
class UnifiedPositionMatrixBuilder:
    ...
    def __init__(self, exchange: str, config: Dict[str, Any], field_mappings: Optional[Dict[str, List[str]]] = None):
        ...
        if exchange == "ice_match":
            self.conversion_ratios = self.normalizer_config.get("product_conversion_ratios", {})
        
        # Get unit defaults
        self.unit_defaults = self.normalizer_config.get("traders_product_unit_defaults", {})
    ...
    def _get_trade_field(self, trade: Dict[str, Any], field_key: str, default: Any = "") -> Any:
    ...
    def _create_trade_detail(self, trade: Dict[str, Any], component: Any, final_quantity: Decimal, 
                            unit: str, product_name: str) -> Dict[str, Any]:
        ...
        spread_flag = self._get_trade_field(trade, "spread", "")  # Get spread flag if present
        ...
        return {
            ...
            "original_product": product_name if (component.is_synthetic or is_decomposed) else None,
            "spread_flag": spread_flag  # Store spread flag for display
        }
    
    def _process_trade(self, trade: Dict[str, Any], matrix: PositionMatrix, source: str) -> None:
        ...
        if not hasattr(self, '_logged_first'):
            ...
            logger.debug(f"Product: {product_name}, Month: {contract_month}, B/S: {buy_sell}")
